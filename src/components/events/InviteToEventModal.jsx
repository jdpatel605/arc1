...
import { inviteMemberEventRequest, eventParticipantsListReset, eventParticipantsListRequest, inviteEventParticipantsRequest, updateEventParticipantsList } from "../../store/actions";
...
const InviteToEventModal = props => {
  ...
  const {
    eventParticipantsList, eventParticipantsPageInfo, eventParticipantsLoading, eventParticipantInviteFlag
