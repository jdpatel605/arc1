...
import {updateOrganizationRequest, getStateListRequest, getCountryRequest, organizationByIdRequest, resetAdminGroupState} from "../../../store/actions";
import history from '../../../history/history';

import {Logger} from '../../../utils/logger';
const fileLocation = "src\\components\\admin\\profile\\index.jsx";
...
const Index = props => {
  ...
  useEffect(() => {
    ...
    dispatch(organizationByIdRequest(adminIdentifier));
  }, []);
  ...
  useEffect(() => {
    if(currentOrg && currentOrg.name) {
      ...
      localStorage.setItem('admin_name', currentOrg.name);
      // localStorage.setItem('admin_avatar', currentOrg.avatar_url);
    }
  }, [currentOrg]);
    ...
    <div className="content-sec">
      ...
      <div className="scroll" id="main-content" style={{'scrollBehavior': 'smooth'}}>
        <div className="container-fluid">
          <ContentHeader />
          <div className="page-contain bg-gray ml-3">
            <div className="row">
                    ...
                    <div className="mob-space">
                        ...
                        <div className="col-lg-6">
                          <div className="upload-img-info">
                            <div className="upload-img">
                              ...
                              <div className="img-upload img-150" onClick={() => imageRef.current.click()}>
                        ...
                        <div className="col-lg-6">
                          <div className="upload-img-info billboard-image">
                            <div className="upload-img">
                              ...
                              <div className="img-upload img-150 bbOrg" onClick={() => bbImageRef.current.click()}>
                          ...
                          <div className="form-group">
                            <div className="bg-black-600 bg-focus">
                              <input type="text" className={`form-control ${validationErrors.name && 'error'}`}
                                id="name" name="name" defaultValue={organizationDetails.name} onKeyUp={updateStateValue} />
                              ...
                              <div className="col-sm-6">
                                <div className="bg-black-600 bg-focus">
                                  <input type="text" className={`form-control ${validationErrors.postalcode && 'error'}`}
                                    ...
                                    value={organizationDetails.postalcode} onChange={updateStateValue} />
                      ...
                      <div className="row mt-4">
                        <div className="col-lg-12 text-right">
                          ...
                          <button type="button" className="btn bg-black-900 md-box btn-medium clr-white mr-3"
                          onClick={resetAllData} disabled={isReset}>Cancel</button>
                          {/* <button type="button" className="btn bg-black-900 md-box btn-medium clr-white mr-3"
                          disabled={isReset}>Cancel</button> */}
                          <button type="button" className={`btn btn-green md-box btn-medium ${!validForm && 'btn-gray-500'}`}
                            onClick={handelUpdateOrganization}
                            disabled={!validForm || updateFlagLoading || isReset}
